...
function Aside() {
return ( 
<aside className=" md:w-[19%] lg:w-[15%] 2xl:w-[10%] bg-[#042940]  flex flex-col justify-between items-center xl:items-start">
    <div className="top flex flex-col gap-10 items-center w-full ">
            
        <p className={`text-md md:text-xl xl:text-2xl mt-4 ml-4 text-[#DBF227] font-extrabold ${lexen.className} self-start `}>TaskFlow</p>
                <div className="links flex flex-col gap-4 w-full">
                    <Link className={`text-[#DBF227] hover:text-[#101214] flex flex-col md:flex-row justify-center md:justify-start items-start gap-1 ${lexen.className} hover:bg-[#9FC131] w-full p-4 py-2 `} href={`/dashboard`}> 
                    ...
                    <Link className={`text-[#DBF227] hover:text-[#101214] flex flex-col md:flex-row justify-center md:justify-start items-start gap-1 ${lexen.className} hover:bg-[#9FC131] w-full p-4 py-2 `} href={`/dashboard/projects`}> 
